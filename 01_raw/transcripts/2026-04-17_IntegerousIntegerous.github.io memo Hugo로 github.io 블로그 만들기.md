---
title: "Integerous/Integerous.github.io: :memo: Hugo로 github.io 블로그 만들기"
source: "https://github.com/Integerous/Integerous.github.io"
author:
published:
created: 2026-04-17
description: ":memo: Hugo로 github.io 블로그 만들기. Contribute to Integerous/Integerous.github.io development by creating an account on GitHub."
type: "youtube"
tags:
  - "clippings"
  - "youtube"
...
- [https://themes.gohugo.io/](https://themes.gohugo.io/) 에서 원하는 테마를 선택한다.
...
[![](https://github.com/Integerous/TIL/raw/master/ETC/images/myfirstPR.png?raw=true)](https://github.com/Integerous/TIL/blob/master/ETC/images/myfirstPR.png?raw=true)
...
```
1. 위의 script를 본인의 블로그 템플릿중 원하는 위치에 넣으면
2. 끝!
...
[![gistExample](https://github.com/Integerous/TIL/raw/master/ETC/images/exampleGist.png?raw=true)](https://github.com/Integerous/TIL/blob/master/ETC/images/exampleGist.png?raw=true)
