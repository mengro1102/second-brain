...
- 저자: [[Junhyuk Oh]], Gregory Farquhar, Iurii Kemaev, Dan A. Calian 등
- 소속: [[Google DeepMind]]
...
2. [[discorl]]은 Atari 57에서 [[MuZero]], Dreamer 등 모든 기존 알고리즘 능가
...
> [!causal] 인과 관계
> [[부트스트래핑]] →(성능 향상)→ [[discorl]]의 예측 품질
> 신뢰도: 높음 | 출처: [[02_wiki/sources/discovering-sota-rl-algorithms]]

## 캡처 맥락

- 목적: 롤모델 [[Junhyuk Oh]]의 최근 연구 follow-up + 세컨드 브레인 테스트
...
[[Junhyuk Oh]], [[Google DeepMind]], [[discorl]], [[MuZero]]
